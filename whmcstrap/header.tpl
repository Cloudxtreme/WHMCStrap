...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="templates/{$template}/static/css/select2.css">
      ...
      <link rel="stylesheet" href="templates/{$template}/static/css/whmcstrap.css">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav" style="width: auto;">
                ...
                {if $loggedin}
                    ...
                    <!-- Services Dropdown -->
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">{$LANG.navservices} <b
                                    class="caret"></b></a>
            ...
            {/if}
                    ...
                    {if $condlinks.domainreg || $condlinks.domaintrans}
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">{$LANG.navdomains} <b
                                        class="caret"></b></a>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                {if $condlinks.domainreg}
                                    <li><a href="cart.php?a=add&domain=register">{$LANG.navregisterdomain}</a></li>{/if}
                                {if $condlinks.domaintrans}
                                    <li><a href="cart.php?a=add&domain=transfer">{$LANG.navtransferdomain}</a></li>{/if}
                                {if $enomnewtldsenabled}
                                    <li><a href="{$enomnewtldslink}">Preregister New TLDs</a></li>{/if}
                    ...
                    <!-- Billing Dropdown -->
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">{$LANG.navbilling} <b
                                    class="caret"></b></a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            {if $condlinks.addfunds}
                                <li><a href="clientarea.php?action=addfunds">{$LANG.addfunds}</a></li>{/if}
                            {if $condlinks.masspay}
                                <li><a href="clientarea.php?action=masspay&all=true">{$LANG.masspaytitle}</a></li>{/if}
                            {if $condlinks.updatecc}
                                <li><a href="clientarea.php?action=creditcard">{$LANG.navmanagecc}</a></li>{/if}
                        </ul>
                    </li>
                    <!-- Support Dropdown -->
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">{$LANG.navsupport} <b
                                    class="caret"></b></a>
            ...
            <li><a href="serverstatus.php">{$LANG.networkstatustitle}</a></li>
                    ...
                    {if $condlinks.affiliates}
                        <li{if $pagetitle == 'Affiliates'} class="active"{/if}><a
                                href="affiliates.php">{$LANG.affiliatestitle}</a></li>{/if}
                ...
                {else}
                    ...
                    <li><a href="serverstatus.php">{$LANG.networkstatustitle}</a></li>
                    {if $condlinks.affiliates}
                        <li class="hidden-sm"><a href="affiliates.php">{$LANG.affiliatestitle}</a></li>{/if}
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                {if $loggedin}
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">{$LANG.hello}
